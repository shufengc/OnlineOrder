...
VALUES
    ('Burger King', '773 N Mathilda Ave, Sunnyvale, CA 94085',
     'https://img.cdn4dd.com/cdn-cgi/image/fit=contain,width=1920,format=auto,quality=50/https://cdn.doordash.com/media/store%2Fheader%2F10171.jpg',
     '(408) 736-0101'),

    ('SGD Tofu House', '3450 El Camino Real #105, Santa Clara, CA 95051',
     'https://img.cdn4dd.com/cdn-cgi/image/fit=contain,width=300,format=auto,quality=50/https://cdn.doordash.com/media/store%2Fheader%2F1579.jpg',
     '(408) 261-3030'),

    ('Fashion Wok', '163 S Murphy Ave, Sunnyvale, CA 94086',
     'https://img.cdn4dd.com/cdn-cgi/image/fit=contain,width=300,format=auto,quality=50/https://cdn.doordash.com/media/store%2Fheader%2F273997.jpg',
     '(408) 739-8866');
...
VALUES
    ...
    ('Our Bacon King Sandwich features two 1/4 lb* savory flame-grilled beef patties, topped with hearty portion of thick-cut smoked bacon, melted American cheese and topped with ketchup and creamy mayonnaise all on a soft sesame seed bun',
    ...
    ('Tofu boiled with mussels, shrimp, and clams. Served with your choice of side and an assortment of kimchi dishes.',
    ...
    ('Squid, clam, imitation crab, and vegetables fried in batter.',
    ...
    ('Beef short ribs served with your choice of side and assortment of kimchi dishes.',
    ...
    ('Rice, BBQ beef, and vegetables are served with an assortment of kimchi dishes.',
    ...
    ('Medium spicy.',
     ...
     '农家小炒肉Stir Fried Pork with Pepper',19.39,3),
    ...
    ('Mild spicy.',
     ...
     '大盘花菜Stir Fried Cauliflower with Beef',17.99,3),
    ...
    ('Very spicy.',
     ...
     '小炒牛肉Spicy Stir Fried Beef with Pepper',16.99,3),
    ...
    ('Very spicy.',
     ...
     '搓辣椒茄子皮蛋Smashed Green Pepper, Chinese Eggplant & Preserved Egg',11.99,3),
