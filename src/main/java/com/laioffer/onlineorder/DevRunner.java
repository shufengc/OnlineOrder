...
public class DevRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        CustomerEntity customer0 =
                new CustomerEntity(null, "user_a@mail.com", "123", true, "Foo", "Bar");
        CustomerEntity customer1 =
                new CustomerEntity(null, "user_b@mail.com", "123", true, "Zoo", "Yoo");
        ...
        List<MenuItemEntity> newMenuItems = List.of(
                ...
                new MenuItemEntity(null, 5L, "entree_bc", "description_bc", 100.0, "https://006.jpg"),
                new MenuItemEntity(null, 6L, "entree_ca", "description_ca", 20.0, "https://007.jpg"),
                new MenuItemEntity(null, 6L, "entree_cb", "description_cb", 88.8, "https://008.jpg"),
                new MenuItemEntity(null, 6L, "entree_cc", "description_cc", 33.3, "https://009.jpg")
        );
        ...
        List<OrderItemEntity> newOrderItems = List.of(
                ...
                new OrderItemEntity(null, 2L, 2L, 1.0, 1),
