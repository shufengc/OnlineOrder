...
public class DevRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // Insert customers
        CustomerEntity customer0 = new CustomerEntity(
                null, "user_a@mail.com", "123", true, "Foo", "Bar");
        customerRepository.save(customer0);

        CustomerEntity customer1 = new CustomerEntity(
                null, "user_b@mail.com", "123", true, "Zoo", "Yoo");
        ...
        List<RestaurantEntity> newRestaurants = List.of(
                new RestaurantEntity(null, "restaurant_a", "address_a",
                        "6505550000", "https://001.jpg"),

                new RestaurantEntity(null, "restaurant_b", "address_b",
                        "6505550001", "https://002.jpg"),

                new RestaurantEntity(null, "restaurant_c", "address_c",
                        "6505550002", "https://003.jpg")
        );
        ...
        List<MenuItemEntity> newMenuItems = List.of(
                ...
                new MenuItemEntity(null, 6L, "entree_cd", "description_cc", 333.3, "https://009.jpg")
        );
